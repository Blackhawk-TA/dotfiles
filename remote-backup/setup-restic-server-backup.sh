...
cp $SCRIPT_DIR/server/restic-backup.service /etc/systemd/system/restic-backup.service
cp $SCRIPT_DIR/server/restic-backup.timer /etc/systemd/system/restic-backup.timer
