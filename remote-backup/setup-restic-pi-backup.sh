...
cp $SCRIPT_DIR/systemd/pi/restic-backup.service /etc/systemd/system/restic-backup.service
cp $SCRIPT_DIR/systemd/pi/restic-backup.timer /etc/systemd/system/restic-backup.timer
